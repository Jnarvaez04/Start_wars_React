      ...
      <div className="w-screen flex flex-row justify-center">
        <div className="shadow rounded-2xl w-80 m-10 p-2">
          <div className="w-full h-44 overflow-hidden rounded-xl">
            <img src="https://ichef.bbci.co.uk/news/640/cpsprodpb/4812/production/_110005481_baby-yoda.jpg" alt="" />
          </div>
        ...
        <div className="shadow rounded-2xl w-80 m-10 p-2">
          <div className="w-full h-44 overflow-hidden rounded-xl">
            <img src="https://www.republica.com/cine-publico/wp-content/uploads/sites/21/2017/12/jar_jar_binks.jpg" alt="" />
          </div>
